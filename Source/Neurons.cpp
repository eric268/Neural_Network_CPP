...
Neurons::Neurons(long float val, LayerType type) :mActivation{ val }, mLayerType{ type }, mBias{ 0.0 }, mDeltaBias{ 0.0 }, mDeltaError{ 0.0 }, mDeltaOutput{ 0.0 } {}